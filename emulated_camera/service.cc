...
#ifdef LAZY_SERVICE
#define LOG_TAG "android.hardware.pixel.camera.provider@2.5-service-lazy"
#else
#define LOG_TAG "android.hardware.pixel.camera.provider@2.5-service"
#endif
...
using ::android::hardware::camera::provider::V2_5::implementation::HidlCameraProvider;
